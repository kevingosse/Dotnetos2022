...
internal unsafe class GCHeap : IGCHeap
{
    ...
    public GCHeap(IGCToCLR gcToClr)
    {
        ...
        Object = NativeObjects.IGCHeap.Wrap(this);
    }

    public NativeObjects.IGCHeap Object { get; }
    public IntPtr GCHandleManager => _gcHandleManager.Object;
    ...
    private void TryLoadDAC()
    {
        ...
        var unknown = NativeObjects.IUnknown.Wrap(ppUnk);

        result = unknown.QueryInterface(KnownGuids.ISOSDacInterface, out var sosDacInterfacePtr);

        _sosDacInterface = NativeObjects.ISOSDacInterface.Wrap(sosDacInterfacePtr);
    }
